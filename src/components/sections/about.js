...
const About = () => {
  ...
  const skills = ['JavaScript (ES6+)', 'Html5', 'Css3', 'Gatsby', 'Bootstrap', 'C Programming', 'SEO', 'Linux', 'WordPress', 'Ghost', 'WooCommerce', 'Git & Github'];
